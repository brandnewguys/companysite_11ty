...
})({"epF2l":[function(require,module,exports) {
...
},{}],"4yWnV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _infinitemenu = require("./infinitemenu");
var _infinitemenuDefault = parcelHelpers.interopDefault(_infinitemenu);
var _podcastBaseScss = require("../css/podcast_base.scss");
const menu = new (0, _infinitemenuDefault.default)(document.querySelector("nav.menu"));

},{"./infinitemenu":"56IAy","../css/podcast_base.scss":"53QTV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"56IAy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class InfiniteMenu {
    ...
    cloneItems() {
        ...
        if (!(this.DOM.menuItems.length < fitIn)) {
            // Remove any
            this.DOM.bngContainer.querySelectorAll(".loop__clone").forEach((clone)=>this.DOM.bngContainer.removeChild(clone));
            // Add clones
            let totalClones = 1;
            this.DOM.menuItems.filter((_, index)=>index < fitIn).map((target)=>{
                const clone = target.cloneNode(true);
                clone.classList.add("loop__clone");
                this.DOM.bngContainer.appendChild(clone);
                this.DOM.bngContainer.prepend(clone);
                ++totalClones;
            });
            // All clones height
    ...
    initScroll() {
        ...
        if (this.scrollPos <= 0) this.setScrollPos(1);
    }
    scrollUpdate() {
        this.scrollPos = this.getScrollPos();
        if (this.clonesHeight + this.scrollPos >= this.scrollHeight) // Scroll to the top when you’ve reached the bottom
        this.setScrollPos(1); // Scroll down 1 pixel to allow upwards scrolling
        else if (this.scrollPos <= 0) // Scroll to the bottom when you reach the top
...
},{}],"53QTV":[function() {},{}]},["epF2l","4yWnV"], "4yWnV", "parcelRequire4214")
