...
})({"lVYUX":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 49742;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9f039dfbb9b2a914";
"use strict";
...
},{}],"gW0BX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _placeholdersJs = require("../components/placeholders/placeholders.js");
var _placeholdersJsDefault = parcelHelpers.interopDefault(_placeholdersJs);
...
var _indexScss = require("../css/index.scss");
(0, _indexJs.constants).isDevice = "ontouchstart" in window;
(0, _indexJs.constants).isDevice && document.body.classList.add("is-device");
// set vh css var
document.documentElement.style.setProperty("--vh", `${window.innerHeight * 0.01}px`);
(0, _indexJs.instances).scroll = new (0, _scrollJsDefault.default)();
(0, _indexJs.instances).scroll.init();
const placeholders = new (0, _placeholdersJsDefault.default)();
placeholders.init();
(0, _indexJs.instances).slider = new (0, _sliderJsDefault.default)();
(0, _indexJs.instances).slider.init();

},{"../components/placeholders/placeholders.js":"hVhHu","../components/slider/slider.js":"eyde0","../utils/scroll.js":"kuw9j","../store/index.js":"d3RXL","../css/index.scss":"1xbik","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hVhHu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
(0, _gsapDefault.default).registerPlugin((0, _customEase.CustomEase));
(0, _customEase.CustomEase).create("in-out-smooth", "M0,0 C0.8,0 0.2,1 1,1");
class Placeholders {
    constructor(){
        this.dom = {};
    ...
    setHoverAnimation() {
        this.tlHover = (0, _gsapDefault.default).timeline({
            paused: true
        });
    ...
    setExpandAnimation() {
        setTimeout(()=>{
            !(0, _store.constants).isDevice && (0, _store.instances).scroll.enable();
            const x1 = this.bounds.left - (0, _store.instances).slider.items[0].bounds.left - 20;
            const x2 = this.bounds.left - (0, _store.instances).slider.items[1].bounds.left + 10;
            const x3 = this.bounds.left - (0, _store.instances).slider.items[2].bounds.left;
            const y1 = this.bounds.top - (0, _store.instances).slider.items[0].bounds.top + 10;
            const y2 = this.bounds.top - (0, _store.instances).slider.items[1].bounds.top - 30;
            const y3 = this.bounds.top - (0, _store.instances).slider.items[2].bounds.top + 30;
            const intersectX1 = (0, _store.constants).isDevice ? 0 : (0, _store.instances).slider.items[0].x;
            const intersectX2 = (0, _store.constants).isDevice ? 0 : (0, _store.instances).slider.items[1].x;
            const intersectX3 = (0, _store.constants).isDevice ? 0 : (0, _store.instances).slider.items[2].x;
            const scale = (0, _store.instances).slider.items[0].bounds.width / this.bounds.width;
            const rotation = 0;
            this.tlExpand = (0, _gsapDefault.default).timeline({
                paused: true,
                onComplete: ()=>{
            ...
            if ((0, _store.constants).isDevice) // set images position + rotation, because there's no hover animation on touch devices
            this.tlExpand.set(this.dom.images, {
                scale: 0.5,
                x: window.innerWidth / 12 * 7,
                rotation: 0
            });
            this.tlExpand.addLabel("start").set(this.dom.el, {
                autoAlpha: 1
                ...
                scale,
                rotation
            }, "start").to(this.dom.images[0].querySelector("img"), {
                duration: 1.67,
                ease: "in-out-smooth",
                x: intersectX1
            }, "start").to(this.dom.images[1].querySelector("img"), {
                duration: 1.67,
                ease: "in-out-smooth",
                x: intersectX2
            }, "start").to(this.dom.images[2].querySelector("img"), {
                duration: 1.67,
                ease: "in-out-smooth",
                x: intersectX3
            ...
            this.tlExpand.play();
            (0, _store.instances).slider.open();
        }, 100);
    }
    handleMouseenter = ()=>{
        if (this.state.animating || (0, _store.constants).isDevice) return;
        this.tlHover.play();
    };
    handleMouseleave = ()=>{
        if (this.state.animating || (0, _store.constants).isDevice) return;
...
},{"gsap":"fPSuC","gsap/CustomEase":"1y1UF","../../store":"d3RXL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
_relExp = /[+-]=-?[\.\d]+/, _delimitedValueExp = /[#\-+.]*\b[a-z\d-=+%.]+/gi, _globalTimeline, _win, _coreInitted, _doc, _globals = {}, _installScope = {}, _coreReady, _install = function _install(scope) {
    ...
    if (!_isObject(target) && !_isFunction(target)) targets = [
        targets
    ];
...
_round = function _round(value) {
    ...
    if (isLegacy) vars.duration = params[1];
    vars.parent = parent;
    if (type) {
        irVars = vars;
        ...
        if (type < 2) vars.runBackwards = 1;
        else vars.startAt = params[varsIndex - 1]; // "from" vars
    }
    return vars;
    ...
    for(var p in defaults)if (!(p in obj) && p !== "duration" && p !== "ease") obj[p] = defaults[p];
}, _merge = function _merge(base, toMerge) {
    for(var p in toMerge)base[p] = toMerge[p];
    return base;
}, _mergeDeep = function _mergeDeep(base, toMerge) {
    for(var p in toMerge)base[p] = _isObject(toMerge[p]) ? _mergeDeep(base[p] || (base[p] = {}), toMerge[p]) : toMerge[p];
    return base;
    ...
    if (child.parent && (!onlyIfParentHasAutoRemove || child.parent.autoRemoveChildren)) child.parent.remove(child);
    child._act = 0;
...
distribute = function distribute(v) {
    ...
    if (animation.progress() < 1) _callback(animation, "onInterrupt");
    return animation;
    ...
    if (config.register) config.register(gsap, Plugin, PropTween);
}, /*
 * --------------------------------------------------------------------------------------
 * COLORS
 * --------------------------------------------------------------------------------------
 */ _255 = 255, _colorLookup = {
    ...
    if (!a) {
        ...
        if (_colorLookup[v]) a = _colorLookup[v];
            ...
            if (!toHSL) {
                ...
                g = l <= .5 ? l * (s + 1) : l + s - l * s;
                r = l * 2 - g;
                if (a.length > 3) a[3] *= 1; //cast as number
                a[0] = _hue(h + 1 / 3, r, g);
                a[1] = _hue(h, r, g);
                a[2] = _hue(h - 1 / 3, r, g);
            } else if (~v.indexOf("=")) {
    ...
    var s = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b", //we'll dynamically build this Regular Expression to conserve file size. After building it, it will be able to find rgb(), rgba(), # (hexadecimal), and named color values like red, blue, purple, etc.,
    p;
...
*/ _easeMap = {}, _customEaseExp = /^[\d.\-M][\d.\-,\s]/, _quotesExp = /["']/g, _parseObjectInString = function _parseObjectInString(value) {
    ...
    ] : _parenthesesExp.exec(name)[1].split(",").map(_numericIfPossible)) : _easeMap._CE && _customEaseExp.test(name) ? _easeMap._CE("", name) : ease;
...
var Animation = /*#__PURE__*/ function() {
    ...
    _proto.play = function play(from, suppressEvents) {
        if (from != null) this.seek(from, suppressEvents);
        return this.reversed(false).paused(false);
    };
    _proto.reverse = function reverse(from, suppressEvents) {
        if (from != null) this.seek(from || this.totalDuration(), suppressEvents);
        return this.reversed(true).paused(false);
    };
    _proto.pause = function pause(atTime, suppressEvents) {
        if (atTime != null) this.seek(atTime, suppressEvents);
    ...
    _proto.reversed = function reversed(value) {
        if (arguments.length) {
            if (!!value !== this.reversed()) this.timeScale(-this._rts || (value ? -_tinyNum : 0)); // in case timeScale is zero, reversing would have no effect so we use _tinyNum.
            return this;
        }
        return this._rts < 0;
    };
    ...
    _proto.eventCallback = function eventCallback(type, callback, params) {
        ...
        if (arguments.length > 1) {
            if (!callback) delete vars[type];
                ...
                vars[type] = callback;
                if (params) vars[type + "Params"] = params;
...
var Timeline = /*#__PURE__*/ function(_Animation) {
    ...
    _proto2.render = function render(totalTime, suppressEvents, force) {
        ...
        */ if (iteration !== prevIteration && !this._lock) {
                    ...
                    if (iteration < prevIteration) rewinding = !rewinding;
                    prevTime = rewinding ? 0 : dur;
                    this._lock = 1;
                    this.render(prevTime || (isYoyo ? 0 : _round(iteration * cycleDuration)), suppressEvents, !dur)._lock = 0;
                    if (!suppressEvents && this.parent) _callback(this, "onRepeat");
    ...
    _proto2.add = function add(child, position) {
        var _this2 = this;
        if (!_isNumber(position)) position = _parsePosition(this, position);
    ...
    _proto2.shiftChildren = function shiftChildren(amount, adjustLabels, ignoreBeforeTime) {
        ...
        while(child){
            if (child._start >= ignoreBeforeTime) child._start += amount;
            child = child._next;
        }
        if (adjustLabels) {
...
var Tween = /*#__PURE__*/ function(_Animation2) {
    ...
    _proto3.kill = function kill(targets, vars) {
        ...
        if (!targets && (!vars || vars === "all")) {
            this._lazy = 0;
            if (this.parent) return _interrupt(this);
        }
        if (this.timeline) {
        ...
        if ((!vars || vars === "all") && _arraysMatch(parsedTargets, killingTargets)) return _interrupt(this);
 ...
 */ var _setterPlain = function _setterPlain(target, property, value) {
    ...
    while(pt){
        next = pt._next;
        if (pt.p === property) pt.modifier(modifier, tween, target);
        pt = next;
    }
 ...
 */ var _gsap = {
    ...
    defaults: function defaults(value) {
        if (value && value.ease) value.ease = _parseEase(value.ease, _defaults.ease);
...
_convertToUnit = function _convertToUnit(target, property, value, unit) {
    ...
    return (0, _gsapCoreJs._round)(curValue / (isSVG ? target.getBBox()[horizontal ? "width" : "height"] : target[measureProperty]) * amount);
    ...
    var pt = new (0, _gsapCoreJs.PropTween)(this._pt, target.style, prop, 0, 1, (0, _gsapCoreJs._renderComplexString)), index = 0, matchIndex = 0, a, result, startValues, startNum, color, startValue, endValue, endNum, chunk, endUnit, startUnit, relative, endValues;
    pt.b = start;
    pt.e = end;
    start += ""; //ensure values are strings
    end += "";
    ...
    if ((0, _gsapCoreJs._relExp).test(end)) pt.e = 0; //if the end string contains relative values or dynamic random(...) values, delete the end it so that on the final render we don't actually set it to the string with += or -= characters (forces it to use the calculated value).
...
_addPxTranslate = function _addPxTranslate(target, start, value) {
    ...
    var cap = 360, isString = (0, _gsapCoreJs._isString)(endValue), endNum = parseFloat(endValue) * (isString && ~endValue.indexOf("rad") ? _RAD2DEG : 1), change = relative ? endNum * relative : endNum - startNum, finalValue = startNum + change + "deg", direction, pt;
    if (isString) {
    ...
    for(p in _transformProps){
        ...
        if (startValue !== endValue && exclude.indexOf(p) < 0) {
            ...
            endNum = parseFloat(endValue);
            plugin._pt = new (0, _gsapCoreJs.PropTween)(plugin._pt, startCache, p, startNum, endNum - startNum, _renderCSSProp);
...
var CSSPlugin = {
    ...
    init: function init(target, vars, tween, index, targets) {
        ...
        for(p in vars){
            ...
            if (specialProp) {
                if (specialProp(this, target, p, endValue, tween)) hasPriority = 1;
            ...
            this.add(style, "setProperty", getComputedStyle(target).getPropertyValue(p) + "", endValue + "", index, targets, 0, 0, p);
                ...
                if (isTransformRelated) {
                    ...
                    if (p === "scale") {
                        this._pt = new (0, _gsapCoreJs.PropTween)(this._pt, cache, "scaleY", cache.scaleY, relative ? relative * endNum : endNum - cache.scaleY);
                        props.push("scaleY", p);
                        p += "X";
                        ...
                        if (cache.svg) _applySVGOrigin(target, endValue, 0, smooth, 0, this);
                            ...
                            if (endUnit !== cache.zOrigin) _addNonTweeningPT(this, cache, "zOrigin", cache.zOrigin, endUnit);
                ...
                if (isTransformRelated || (endNum || endNum === 0) && (startNum || startNum === 0) && !_complexExp.test(endValue) && p in style) {
                    ...
                    endUnit = (endValue + "").substr((endNum + "").length) || (p in (0, _gsapCoreJs._config).units ? (0, _gsapCoreJs._config).units[p] : startUnit);
                    if (startUnit !== endUnit) startNum = _convertToUnit(target, p, startValue, endUnit);
                    this._pt = new (0, _gsapCoreJs.PropTween)(this._pt, isTransformRelated ? cache : style, p, startNum, relative ? relative * endNum : endNum - startNum, endUnit === "px" && vars.autoRound !== false && !isTransformRelated ? _renderRoundedCSSProp : _renderCSSProp);
        ...
        if (hasPriority) (0, _gsapCoreJs._sortPropTweensByPriority)(this);
    },
    get: _get,
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1y1UF":[function(require,module,exports) {
/*!
 * CustomEase 3.4.0
 * https://greensock.com
 *
...
_needsParsingExp = /[cLlsSaAhHvVtTqQ]/g, _findMinimum = function _findMinimum(values) {
    ...
    for(i = 1; i < l; i += 6)if (+values[i] < min) min = +values[i];
    return min;
...
var CustomEase = /*#__PURE__*/ function() {
    function CustomEase(id, data, config) {
        if (!_coreInitted) _initCore();
        this.id = id;
        if (_bonusValidated) this.setData(data, config);
    }
    ...
    _proto.setData = function setData(data, config) {
        ...
        if (this.id) gsap.registerEase(this.id, this.ease);
        return this;
    };
...
_round = function _round(value) {
    ...
    if (!skipOuter) rawPath.reverse();
    while(i--)if (!rawPath[i].reversed) reverseSegment(rawPath[i]);
...
function sliceRawPath(rawPath, start, end) {
    if (_isUndefined(end)) end = 1;
    start = start || 0;
    var reverse = start > end, loops = Math.max(0, ~~(_abs(end - start) - 1e-8));
    if (reverse) {
        reverse = end;
        end = start;
        start = reverse;
    ...
    var path = copyRawPath(rawPath.totalLength ? rawPath : cacheRawPathMeasurements(rawPath)), wrap = end > 1, s = getProgressData(path, start, _temp, true), e = getProgressData(path, end, _temp2), eSeg = e.segment, sSeg = s.segment, eSegIndex = e.segIndex, sSegIndex = s.segIndex, ei = e.i, si = s.i, sameSegment = sSegIndex === eSegIndex, sameBezier = ei === si && sameSegment, invertedOrder = sameSegment && si > ei || sameBezier && s.t > e.t, sShift, eShift, i, copy, totalSegments, l, j;
    if (wrap || loops) {
        if (_splitSegment(path, sSegIndex, si, s.t)) {
            sShift = 1;
            sSegIndex++;
            if (sameBezier) {
                if (invertedOrder) e.t /= s.t;
                else {
                    e.t = (e.t - s.t) / (1 - s.t);
                    eSegIndex++;
                    ei = 0;
                ...
                eSegIndex++;
                if (sameSegment) ei -= si;
            }
        }
        if (!e.t) {
            eSegIndex--;
            if (reverse) sSegIndex--;
        } else if (_splitSegment(path, eSegIndex, ei, e.t)) {
            if (invertedOrder && sShift) sSegIndex++;
            if (reverse) eSegIndex++;
        }
        copy = [];
        ...
        if (start !== end) {
            ...
            if (sameSegment) eShift += sShift;
            eSeg.splice(ei + eShift + 2);
            if (sShift || si) sSeg.splice(0, si + sShift);
            i = path.length;
            while(i--)//chop off any extra segments
            if (i < sSegIndex || i > eSegIndex) path.splice(i, 1);
        } else {
    ...
    if (reverse) _reverseRawPath(path, wrap || loops);
    path.totalLength = 0;
    return path;
}
...
function simplifyStep(points, first, last, tolerance, simplified) {
    ...
    if (maxSqDist > tolerance) {
        if (index - first > 2) simplifyStep(points, first, index, tolerance, simplified);
        simplified.push(points[index], points[index + 1]);
        if (last - index > 2) simplifyStep(points, index, last, tolerance, simplified);
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d3RXL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "constants", ()=>constants);
parcelHelpers.export(exports, "instances", ()=>instances);
const constants = {
    isDevice: false
};
const instances = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eyde0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
...
class Slider {
    ...
    render = ()=>{
        if ((0, _store.constants).isDevice) return;
        const scrollLast = Math.abs((0, _store.instances).scroll.state.last);
        this.items.forEach((item)=>{
            ...
            if (inView) {
                ...
                const newMax = 0;
                item.x = (percentage - 0) / 100 * (newMax - newMin) + newMin;
                item.img.style.transform = `translate3d(${item.x}px, 0, 0) scale(1.75)`;
            }
        });
        if (this.state.scrollEnabled) {
            const min = 0;
            const max = -(0, _store.instances).scroll.state.bounds.width + window.innerWidth;
            this.state.progress = ((0, _store.instances).scroll.state.last - min) * 100 / (max - min) / 100;
    ...
    open = ()=>{
        ...
        tl.addLabel("start").set(this.dom.items, {
            autoAlpha: 0
        }).set(this.dom.el, {
            autoAlpha: 1
            ...
            duration: 1.5,
            autoAlpha: 1
        }, "+=0.1").to(this.dom.buttonCloseCircle, {
            duration: 1.5,
            ease: "Expo.easeInOut",
            strokeDashoffset: 0
        }, "start+=0.1").set(this.dom.items, {
            autoAlpha: 1
        }, "start+=0.5").set(this.dom.images, {
            autoAlpha: 0
        }, "start+=0.5").set(this.dom.images, {
            autoAlpha: 1
        }, "start+=1.67").call(()=>{
            // reset scroll position
            if ((0, _store.constants).isDevice) this.dom.container.scrollLeft = 0;
            else {
                (0, _store.instances).scroll.state.current = 0;
                (0, _store.instances).scroll.state.last = 0;
            }
            ...
            y: 0,
            rotation: 0
        }, "start+=0.5").to(this.dom.buttons, {
            duration: 1.6,
            stagger: 0.15,
            ease: "in-out-smooth",
            y: 0
        }, "start+=0.6").to(this.dom.progressWrap, {
            duration: 0.6,
            ease: "in-out-smooth",
            autoAlpha: 1
        }, "start+=0.73");
    ...
    close = ()=>{
        if (!this.state.open) return;
        (0, _store.instances).scroll.disable();
        ...
        const tl = (0, _gsapDefault.default).timeline({
            paused: true,
            onComplete: ()=>{
                if (!(0, _store.constants).isDevice) {
                    // reset scroll position
                    (0, _store.instances).scroll.state.current = 0;
                    (0, _store.instances).scroll.state.last = 0;
                    this.state.progress = 0;
                } else this.dom.container.scrollLeft = 0;
            }
        });
        tl.addLabel("start");
        tl.to(this.dom.items, {
            ...
            duration: 0.5,
            autoAlpha: 0
        }, "start").to(this.dom.progressWrap, {
            duration: 0.5,
            autoAlpha: 0
        }, "start").to(this.dom.buttonOpen, {
            duration: 0.5,
            autoAlpha: 1
        }, "start+=0.5").to(this.dom.content, {
            duration: 0.8,
            autoAlpha: 1
        }, "start+=1.1").set(this.dom.items, {
            y: 0
        }).set(this.dom.el, {
            autoAlpha: 0
        });
    ...
    init() {
        (0, _gsapDefault.default).ticker.add(this.render);
        this.setCache();
        this.addListeners();
    }
}
...
},{"gsap":"fPSuC","gsap/CustomEase":"1y1UF","../../store":"d3RXL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kuw9j":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Scroll {
    constructor(){
        this.vs = new (0, _virtualScrollDefault.default)();
    ...
    smooth = ()=>{
        this.state.last = (0, _math.lerp)(this.state.last, this.state.current, this.options.ease);
    ...
    enable() {
        if (!(0, _store.constants).isDevice) {
            ...
            (0, _gsap.gsap).ticker.add(this.smooth);
        } else (0, _gsap.gsap).ticker.add(this.native);
    }
    disable() {
        if (!(0, _store.constants).isDevice) {
            this.vs.off(this.calc);
            (0, _gsap.gsap).ticker.remove(this.smooth);
        } else (0, _gsap.gsap).ticker.remove(this.native);
    }
    handleMouseup = ()=>{
    ...
    handleMousemove = (e)=>{
        ...
        this.state.current = (0, _math.clamp)(this.state.current, 0, -this.state.bounds.width + window.innerWidth);
    };
    handleMouseleave = ()=>{
        this.state.dragging = false;
        this.state.dragEnd = this.state.current;
    ...
    init() {
        if ((0, _store.constants).isDevice) {
            this.handleResize();
            this.vs.destroy();
            (0, _gsap.gsap).ticker.add(this.native);
        }
        if (!(0, _store.constants).isDevice) {
            this.handleResize();
            this.vs.on(this.calc);
...
},{}],"aEcwi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1xbik":[function() {},{}]},["lVYUX","gW0BX"], "gW0BX", "parcelRequire4214")
